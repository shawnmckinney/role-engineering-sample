...
public class GlobalIds
{
    ...
    public static final String BUYERPAGE_OBJNAME = "BuyersPage";
    public static final String SELLERPAGE_OBJNAME = "SellersPage";
    //public static final String PAGE2_OBJNAME = "com.mycompany.Page2";
    //public static final String PAGE3_OBJNAME = "com.mycompany.Page3";
    public static final String BUYERS_PAGE_OBJNAME = "Buyers";
